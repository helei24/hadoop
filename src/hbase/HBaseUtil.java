...
public class HBaseUtil {
    ...
    public static Configuration getConfiguration() {
        ...
        conf.set("hbase.zooker.quorum", "localhost");
        return conf;
    }
     ...
     * @throws IOException
     */
    public static ResultScanner getResultScanner(String tableName, String columnFamily,
        ...
        // 指定要查询的列族
        scan.addColumn(columnFamily.getBytes(), null);
        // 查询列族中值等于queryCondition的记录
        Filter filter1 = new SingleColumnValueFilter(columnFamily.getBytes(), null,
                CompareOp.EQUAL, queryCondition.getBytes());
        // Filter filter2 = new
        // SingleColumnValueFilter(Bytes.toBytes(columnFamily),null,CompareOp.EQUAL,Bytes.toBytes("chuliuxiang"));
